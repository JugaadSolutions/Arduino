...
class MBSLAVE
{
	...
	// function definitions
	boolean  modbus_update(unsigned char *count, unsigned char *_functionCode );
	
	void modbus_update_comms(unsigned int baud, unsigned char byteFormat, unsigned char _slaveID);
	...
	void sendResponse(unsigned short *buffer, unsigned char _dataCount, unsigned char function );
};
