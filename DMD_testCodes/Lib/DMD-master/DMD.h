/*--------------------------------------------------------------------------------------
 ...
 DMD.h   - Function and support library for the  DMD, a 512 LED matrix display
...
#define PIN_DMD_CLK       13   // D13_SCK  is SPI Clock if SPI is used 52//
#define PIN_DMD_SCLK      8    // D8
#define PIN_DMD_R_DATA    11   // D11_MOSI is SPI Master Out if SPI is used 51//
